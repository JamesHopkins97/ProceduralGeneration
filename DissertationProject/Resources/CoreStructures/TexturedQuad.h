...
private:
	...
	int sample, screenHeight, screenWidth;

	//
	// Private API
	//

	void loadShader(bool useSSAA = false);
...
public:
	...
	TexturedQuad(GLuint initTexture, bool invertV = false, bool SSAA = false,  int sWidth = 0, int sHeight = 0, int sample = 1);
